...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-criml1a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-criml1a.containers.anotherwebservice.com/
...
```
git clone git@github.com:caseyisrdppro20/container-criml1a.git
cd container-criml1a
```
...
```
docker attach container-criml1a
```
